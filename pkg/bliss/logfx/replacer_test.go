	...
	tests := []struct {
		...
		},
		{
			...
			expected: []string{
				...
				fmt.Sprint("github.com/eser/acik.io/pkg/bliss/logfx_test.TestTraceLines.func1 ", pwd(), ":117"),
				fmt.Sprint("github.com/eser/acik.io/pkg/bliss/logfx_test.TestTraceLines ", pwd(), ":145"),
		...
		},
		{
			...
			expected: []string{
				"unknown",
				fmt.Sprint("github.com/eser/acik.io/pkg/bliss/logfx_test.TestTraceLines ", pwd(), ":147"),
			},
		},
	}
